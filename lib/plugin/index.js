...
class DegreeDaysTableChartPlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    const metadata = new _core.ChartMetadata({
      description: 'Degree Days Table',
      name: (0, _core.t)('Degree Days Table'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../DegreeDaysTable'))),
      metadata,
...
exports.default = DegreeDaysTableChartPlugin;